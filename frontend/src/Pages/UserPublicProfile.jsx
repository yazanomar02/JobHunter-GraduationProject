            ...
            <div className="p-8 bg-white rounded shadow-md w-10/12 mt-7">
                ...
                <span className="flex gap-3 text-gray-800 justify-center my-2 text-lg hover:cursor-pointer">
                    ...
                    {userDetails?.userProfile?.socialProfiles?.email && (
                        <a
                            href={`mailto:${userDetails.userProfile.socialProfiles.email}`}
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                    ...
                    {userDetails?.userProfile?.socialProfiles?.whatsapp && (
                        <a
                            href={`https://wa.me/${userDetails.userProfile.socialProfiles.whatsapp}`}
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                            <i
                ...
                <h3 className="text-center my-2 font-medium text-gray-600">
                    About
                </h3>
                ...
                {userDetails?.userProfile?.workExperience.length > 0 && (
                    <div>
                        ...
                        {userDetails?.userProfile?.workExperience.map(
                            (exp, index) => (
                                <div
                                    key={index}
                ...
                {userDetails?.userProfile?.skills.length > 0 && (
                    <div>
                        ...
                        <div className="flex gap-4 flex-wrap my-2">
                            {userDetails?.userProfile?.skills.map(
                                (skill, index) => (
                                    <div
                                        key={index}
